...
type Props = { tenantId: string; tripId: string; capacityMode: "seat" | "open"; capacity: number; entries: readonly TransportManifestSummary[]; customerNames: Readonly<Record<string, string>>; onMessage: (message: string, kind?: "error" | "ready") => void };

export function TransportManifest({ tenantId, tripId, capacityMode, capacity, entries, customerNames, onMessage }: Props) {
