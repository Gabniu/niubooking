...
| CAP-GTFS-001 | GTFS Schedule publication | Transit interoperability | Transport; Charter | in progress | Stable public IDs, validated Schedule draft rules, deterministic core GTFS text serialization with after-midnight service times, calendars/exceptions, shapes, and frequencies, plus admitted staff readiness/validation review; immutable version publication, independent validator, and public endpoint remain | TEST-GTFS-001 | BATCH-005 |
