...
| CAP-LIVE-002 | Customer live vehicle map and ETA | Live operations | Transport; Charter | in progress | Issued tickets exchange for short-lived hashed viewer sessions; route geometry and named/geocoded stops are now exposed through the privacy-safe public ticket/trip projection with an accessible SVG preview and live marker when coordinates exist; MapLibre/tiles, route matching, smooth movement, and ETA-range projection remain | TEST-LIVE-002 | BATCH-005 |
