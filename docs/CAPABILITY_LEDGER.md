...
| CAP-LIVE-002 | Customer live vehicle map and ETA | Live operations | Transport; Charter | in progress | Issued-ticket live projection and SSE status now provide route label, freshness, last captured position, accuracy, heading, and a null-safe ETA placeholder without tenant/device/driver identity; short-lived viewer session, public MapLibre tracker, route matching, and ETA-range projection remain | TEST-LIVE-002 | BATCH-005 |
