...
| CAP-TRN-001 | Route, stop, trip, and passenger journey | Transport | Transport | in progress | Domain, additive route/trip/reservation persistence, tenant-safe API search/publish/reservation, and atomic capacity admission; public journey, ticket, and cancellation next | TEST-TRN-001 | BATCH-004 |
