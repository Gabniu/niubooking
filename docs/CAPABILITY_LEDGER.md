...
| CAP-LIVE-002 | Customer live vehicle map and ETA | Live operations | Transport; Charter | in progress | Issued tickets exchange for short-lived hashed viewer sessions; route geometry and named/geocoded stops are exposed through the privacy-safe public ticket/trip projection with an accessible SVG fallback, optional style-URL-gated MapLibre map, reduced-motion-aware sample-to-sample smoothing, freshness/accuracy/confidence details, and honest null-ETA copy; provider route matching, ETA calculation, shareable tracking, and physical-device proof remain | TEST-LIVE-002 | BATCH-005 |
