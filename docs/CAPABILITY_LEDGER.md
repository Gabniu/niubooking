...
| CAP-LIVE-001 | Driver location ingestion and trip matching | Live operations | Transport; Charter | in progress | Branch-scoped trip/device/assignment/session persistence, replay-safe current/history state, NIU Driver with Traccar Client SDK, NIU telemetry gateway, optional private Traccar hardware forwarder | TEST-LIVE-001 | BATCH-005 |
