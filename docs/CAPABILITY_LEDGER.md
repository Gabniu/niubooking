...
| CAP-TRN-001 | Route, stop, trip, and passenger journey | Transport | Transport | in progress | Domain and additive route/trip persistence; API search and passenger journey next | TEST-TRN-001 | BATCH-004 |
