...
Status: implemented foundation; public booking and manage-booking Next migrations are complete, while provider delivery and richer discovery remain in progress
...
4. Apply it first to the Next manage-booking and appointment/QR booking flows.
