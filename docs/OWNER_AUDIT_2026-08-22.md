...
| Graph | Graphify code-only refresh: 3,665 nodes, 5,921 edges; current clustering output 346 communities; previous Obsidian export: 4,011 notes | Architecture relationships refreshed; community count can vary between clustering runs; semantic doc extraction was unavailable without a configured graph LLM backend |
