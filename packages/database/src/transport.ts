...
import { isCapacityReserving, validateReservationStatusChange, validateTransportPassengerReservationDraft, validateTransportRouteDraft, validateTransportTicketDraft, validateTransportTripDraft, type PublicTransportTicket, type PublicTransportTrip, type ReservationStatus, type TransportManifestEntry, type TransportPassengerReservation, type TransportPassengerReservationDraft, type TransportRoute, type TransportRouteDraft, type TransportTicket, type TransportTrip, type TransportTripDraft } from "@bookingapp/domain";
